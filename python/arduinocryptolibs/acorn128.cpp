...
// Acorn 128 Python3 Wrapper using Boost.Python (boost.org)
...
bp::object encrypt_wrap(AuthenticatedCipher& ref, bp::object buf)
{
    ...
    // Creer un buffer d'output sur la stack et chiffrer
    ...
    delete[] outputBuffer;  // Cleanup stack
    return py_ba;
};
...
bp::object decrypt_wrap(AuthenticatedCipher& ref, bp::object buf)
{
    ...
    // Creer un buffer d'output sur la stack et dechiffrer
    char* outputBuffer = new char[len + 1];
